...
//     if (currentSectionIndex < workExperiences[readMoreIndex].detailedDescription.length - 1) {
//       setCurrentSectionIndex(currentSectionIndex + 1);
//     }
//   };
...
//         >
//           <LinearGradient colors={experience.bgColor} style={styles.container}>
//             <Animatable.View
//               ref={(ref) => (slideRefs.current[index] = ref)}
//               animation="fadeInUp"
//               duration={1000}
...
//   achievementItem: { flexDirection: 'row', alignItems: 'center', marginVertical: 5 },
//   achievementText: { marginLeft: 10, color: '#FFFFFF', fontSize: 16 },
//   achievementCategory: { fontWeight: 'bold', color: '#1DB954' },
//   achievementDetail: { color: '#DDDDDD', fontWeight: 'normal' },
//   readMoreButton: { marginTop: 20, padding: 10, backgroundColor: '#1DB954', borderRadius: 5 },
//   readMoreText: { color: '#FFFFFF', fontSize: 16, fontWeight: 'bold' },
//   modalContainer: {
//     position: 'absolute',
